      ...
      <div className="flex flex-col">
        ...
        <div className="flex gap-3 justify-center">
          <button
            ...
            className={`flex items-center gap-2 px-8 py-4 rounded-full border-2 font-nunito font-semibold text-sm transition-all ${
              mode === 'single'
        ...
        <div className="flex gap-3 justify-center">
          <button
            ...
            className={`px-8 py-4 rounded-full border-2 font-nunito font-semibold text-sm transition-all ${
              movieCount === 8
                ? 'bg-primary text-white border-primary'
                : 'bg-white text-foreground/70 border-foreground/20'
            }`}
        ...
        <button
          ...
          className={`w-full px-8 py-5 rounded-2xl font-fredoka font-bold text-base transition-all ${
            canStartTournament()
